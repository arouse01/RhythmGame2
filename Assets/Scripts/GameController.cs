...
public class GameController : MonoBehaviour
{
    ...
    public void StartSession()
    {
        ...
        if (CheckPrefs())
        {
            ...
            //wheelSession.StartSession(sessionFile);
            ...
            //EventLogger.LogEvent("Game", "Game Type", Application.productName);
    ...
    {
        // TODO need to split this into two functions: one in GameController that just updates the lives objects, and second in WheelSession that triggers LRS and such
        switch (currLives)
        {
            case 0:
                // reached zero lives
    ...
    //public List<double> GetAngles(List<double> tapTimes, List<double> tickTimes)
    //{
    ...
    //public double CircMean(List<double> angleList, bool returnRad=true)
    //{
    //    double sinSum = 0.0;
    //    double cosSum = 0.0;
    ...
    //public double CircVectorLength(List<double> angleList)
    //{
    //    double sinSum = 0.0;
    //    double cosSum = 0.0;
